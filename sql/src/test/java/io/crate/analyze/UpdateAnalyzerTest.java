...
public class UpdateAnalyzerTest extends BaseAnalyzerTest {
    ...
    public void testUpdateWithParameter() throws Exception {
        ...
        assertThat(
                analysis.assignments().get(USER_TABLE_INFO.getReferenceInfo(new ColumnIdent("name"))),
                isLiteral("Jeltz")
        );
        assertThat(
                analysis.assignments().get(USER_TABLE_INFO.getReferenceInfo(new ColumnIdent("friends"))),
                isLiteral(friends, new ArrayType(DataTypes.OBJECT))
        );
        assertThat(
                analysis.assignments().get(USER_TABLE_INFO.getReferenceInfo(new ColumnIdent("other_id"))),
                isLiteral(0L)
        );
    ...
    public void testUpdateWithEmptyObjectArray() throws Exception {
        ...
        Literal friendsLiteral = (Literal)analysis.assignments().get(
                USER_TABLE_INFO.getReferenceInfo(new ColumnIdent("friends")));
