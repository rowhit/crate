...
public class DocIndexMetaData {
    ...
    private void initializeGeneratedExpressions() {
        ...
        for (Reference reference : generatedColumnReferences) {
            GeneratedReference generatedReferenceInfo = (GeneratedReference) reference;
            ...
            generatedReferenceInfo.referencedReferenceInfos(ImmutableList.copyOf(tableReferenceResolver.references()));
