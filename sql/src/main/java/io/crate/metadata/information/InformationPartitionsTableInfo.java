...
public class InformationPartitionsTableInfo extends InformationTableInfo {
    ...
    public static class ReferenceInfos {
        ...
        public static final Reference PARTITION_IDENT = info(Columns.PARTITION_IDENT, DataTypes.STRING);
        public static final Reference VALUES = info(Columns.VALUES, DataTypes.OBJECT);
