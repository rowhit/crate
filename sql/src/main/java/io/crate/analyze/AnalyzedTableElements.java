...
public class AnalyzedTableElements {
    ...
    private void validateGeneratedColumns(TableIdent tableIdent,
        ...
        for (AnalyzedColumnDefinition columnDefinition : columns) {
            buildReferenceInfo(tableIdent, columnDefinition, tableReferences);
        }
        if (tableInfo != null) {
    ...
    private void buildReferenceInfo(TableIdent tableIdent, AnalyzedColumnDefinition columnDefinition, List<Reference> references) {
        Reference reference;
        if (columnDefinition.generatedExpression() == null) {
        ...
        for (AnalyzedColumnDefinition childDefinition : columnDefinition.children()) {
            buildReferenceInfo(tableIdent, childDefinition, references);
        }
    }
