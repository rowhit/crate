...
public class DocTableRelation extends AbstractTableRelation<DocTableInfo> {
    ...
    public Field getField(Path path, Operation operation) throws UnsupportedOperationException, ColumnUnknownException {
        ...
        Reference reference = tableInfo.getReferenceInfo(ci);
        if (reference == null) {
    ...
    private void ensureColumnCanBeUpdated(ColumnIdent ci) {
        ...
        List<GeneratedReference> generatedReferenceInfos = tableInfo.generatedColumns();
        ...
        for (ColumnIdent partitionIdent : tableInfo.partitionedBy()) {
            ...
            if (idx >= 0) {
                GeneratedReference generatedReferenceInfo = generatedReferenceInfos.get(idx);
                for (Reference reference : generatedReferenceInfo.referencedReferenceInfos()) {
